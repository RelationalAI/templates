...
| [supply_chain_resilience](v1/supply_chain_resilience/) | Graph, Predictive, Rules-based, Prescriptive | Chain blast-radius reachability, network analysis, a graph neural network (GNN) that forecasts per-supplier delay risk, and rule-based risk classification into a risk-adjusted minimum-cost network flow for supply-chain routing. |
