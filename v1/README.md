...
| [entity_resolution](./entity_resolution/) | Graph, Rules-based, Prescriptive | Resolve duplicate policyholder records across an insurer's policy systems and acquired books, then aggregate exposure per resolved household and choose minimum-cost reinsurance cessions to clear accumulation breaches: graph clustering, rules, and a prescriptive knapsack. |
