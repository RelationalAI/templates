...
| [underwriting_audit](./underwriting_audit/) | Audit an underwriting ruleset by enumerating K distinct counterexample applicants who falsify a stated property: each witness shows a way the rules let an unintended applicant through. CSP solver in multi-solution mode. |
