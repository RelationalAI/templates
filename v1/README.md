...
| [datacenter_compute_allocation](./datacenter_compute_allocation/) | Multi-reasoner template (chain follow-up to energy_grid_planning): heterogeneous-graph GNN demand forecasting, hardware-compatibility rules, dependency PageRank, and 3D-scenario MIP for inside-the-fence GPU allocation across hyperscaler campuses. |
