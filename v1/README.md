...
| [grid_interconnection](./grid_interconnection/) | Explore the tradeoff between project revenue and infrastructure investment using bi-objective optimization with epsilon constraint. |
...
| [portfolio_balancing](./portfolio_balancing/) | Explore the risk-return tradeoff using bi-objective Markowitz optimization with epsilon constraint. |
