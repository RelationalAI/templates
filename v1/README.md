...
| [financial_index_replication](./financial_index_replication/) | Select a sparse 20-stock basket and weights to track an S&P 500-like benchmark while respecting sector, liquidity, and turnover constraints. |
