...
| [entity_resolution](./entity_resolution/) | Graph, Rules-based | Resolve duplicate policyholder records across an insurer's policy systems and acquired books into one record per insured party, using fuzzy matching, weakly-connected-components clustering, and confidence-tier rules. |
