...
6. **Expected output**
   ...
   ```
   ==============================================================================================================
   WILDLIFE CONSERVATION NETWORK - COMMUNITY DETECTION ANALYSIS (LOUVAIN ALGORITHM)
   ==============================================================================================================
   ...
   Organizations in the same community share dense connections, indicating:
     • Active collaboration on shared conservation goals
     • Geographic or species-based coordination
     • Opportunities for resource sharing within clusters
     • Potential gaps in cross-community collaboration

   --------------------------------------------------------------------------------------------------------------
   community                           name             type          region      focus_species  degree_centrality  partnerships
           0        Serengeti Wildlife Trust              NGO     East Africa         Elephants             0.3636             6
           0           Big Cats Initiative              NGO     East Africa  Lions & Leopards             0.2727             4
           0  East African Research Station         Research     East Africa  Multiple Species             0.2727             4
           0      Amboseli Elephant Project         Research     East Africa         Elephants             0.2727             3
           0        Savanna Research Center         Research     East Africa  Multiple Species             0.2727             3
           0     Wildlife Veterinary Network          Medical     East Africa  Multiple Species             0.2727             3
           0    Community Conservation Program        Community     East Africa  Multiple Species             0.2727             3
           1     Rhino Conservation Alliance              NGO  Southern Africa            Rhinos             0.2727             4
           1          Kruger Park Authority          Reserve  Southern Africa  Multiple Species             0.2727             3
           1      Southern Wildlife Foundation              NGO  Southern Africa            Rhinos             0.2727             3
           1         Trans-Border Conservation              NGO  Southern Africa  Multiple Species             0.1818             2
           1            Rhino Protection Unit         Security  Southern Africa            Rhinos             0.1818             2
   --------------------------------------------------------------------------------------------------------------

   🌍 DETECTED 2 CONSERVATION COMMUNITIES:

     Community 0:
       Size: 7 organizations
       Primary Region: East Africa
       Species Focus: Multiple Species, Elephants, Lions & Leopards
       Organization Types: NGO (2), Research (3), Medical (1), Community (1)
       Hub Organization: Serengeti Wildlife Trust (centrality: 0.3636)
       Members: Serengeti Wildlife Trust, Big Cats Initiative, East African Research Station, Amboseli Elephant Project, Savanna Research Center, Wildlife Veterinary Network, Community Conservation Program

     Community 1:
       Size: 5 organizations
       Primary Region: Southern Africa
       Species Focus: Rhinos, Multiple Species
       Organization Types: NGO (3), Reserve (1), Security (1)
       Hub Organization: Rhino Conservation Alliance (centrality: 0.2727)
       Members: Rhino Conservation Alliance, Kruger Park Authority, Southern Wildlife Foundation, Trans-Border Conservation, Rhino Protection Unit

   📊 NETWORK SUMMARY:
     • Total organizations: 12
     • Number of communities detected: 2
     • Average community size: 6.0 organizations
     • Average partnerships per organization: 3.2
     • Most connected organization: Serengeti Wildlife Trust (6 partnerships)
     • Total partnerships in network: 19

   💡 RECOMMENDATIONS:
     • Communities represent natural collaboration clusters based on geography, species focus, or expertise
     • Organizations within the same community should leverage close partnerships for resource sharing
     • Consider creating cross-community liaisons to improve coordination across clusters
     • Hub organizations in each community are ideal candidates for leadership and coordination roles
